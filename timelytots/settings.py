...
CORS_ALLOWED_ORIGINS = [
    "http://localhost:61807",   # exact origin from your browser
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'templates')],  # 👈 Add your global templates folder
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
DATABASES = {
    'default': {
        ...
        'HOST': '160.250.205.123',               # since DB and app are on same EC2
        'PORT': '5432',
    }
}
